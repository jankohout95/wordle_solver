...
"""
This function returns list of all possible guesses. Each guess contains 0 or 1. If the guess word is in a list of
possible answers the number is 1, otherwise 0.
"""
...
def simulate_games(first_guess=None,
    ...
    for answer in ProgressDisplay(test_set, leave=False, desc=" Trying all wordle answers"):
        ...
        while guess != answer:
            ...
            print("Possibility counts: " + str(possibility_counts))
            score += 1
        ...
        # Accumulate stats
        """
        Frequency of each score. Possible scores 1, 2, 3, 4, 5, 6.
        Each score represents how many turns it gets to match the answer.
        """
        scores = np.append(scores, [score])

        """
        Simple distribution of score frequencies.
        """
        score_dist = [
            int((scores == i).sum())
